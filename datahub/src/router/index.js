...
function makeWorkbenchRoute({ key, name, roles }) {
  return {
    ...
    children: [
      ...
      { path: 'todo', name: `${key}-todo`, component: () => import('@/pages/workbench/commission/Tickets.vue'), meta: { title: '统一待办' } },
      { path: 'favorites', name: `${key}-favorites`, component: () => import('@/pages/workbench/personal/MyCart.vue'), meta: { title: '我的收藏' } },
      { path: 'operation', name: `${key}-operation`, component: () => import('@/pages/workbench/commission/DemandSubmit.vue'), meta: { title: '运营过程管理' } },
      { path: 'ops', name: `${key}-ops`, component: () => import('@/pages/workbench/commission/ApiManage.vue'), meta: { title: '智能运维' } },
      { path: 'metadata', name: `${key}-metadata`, component: () => import('@/pages/workbench/commission/FeaturePlaceholder.vue'), meta: { title: '统一元数据管理' } },
      { path: 'data-compile', name: `${key}-data-compile`, component: () => import('@/pages/workbench/commission/FeaturePlaceholder.vue'), meta: { title: '数据编制' } },
      { path: 'resource', name: `${key}-resource`, component: () => import('@/pages/workbench/commission/Whitelist.vue'), meta: { title: '统一资源管理' } },
      { path: 'front-machine', name: `${key}-front-machine`, component: () => import('@/pages/manage/resource/FrontMachine.vue'), meta: { title: '前置机管理' } },
      ...
      { path: 'data-share', name: `${key}-data-share`, component: () => import('@/pages/workbench/commission/FeaturePlaceholder.vue'), meta: { title: '数据共享' } },
      { path: 'data-open', name: `${key}-data-open`, component: () => import('@/pages/workbench/commission/FeaturePlaceholder.vue'), meta: { title: '数据开放' } },
      ...
      { path: 'supply-demand', name: `${key}-supply-demand`, component: () => import('@/pages/workbench/commission/SupplyDemandStats.vue'), meta: { title: '供需统计' } },
